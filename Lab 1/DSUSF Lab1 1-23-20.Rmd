...
- From the development side, we can leverage this feature to see, for example, how many observations are there of 'Virginica" (basic example) using the __length_ function
